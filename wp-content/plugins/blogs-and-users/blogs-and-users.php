...
define ('BAU_PLUGIN_SELF_DIRNAME', basename(dirname(__FILE__)), true);
define ('BAU_PROTOCOL', (@$_SERVER["HTTPS"] == 'on' ? 'https://' : 'http://'), true);

//Setup proper paths/URLs and load text domains
if (is_multisite() && defined('WPMU_PLUGIN_URL') && defined('WPMU_PLUGIN_DIR') && file_exists(WPMU_PLUGIN_DIR . '/' . basename(__FILE__))) {
	define ('BAU_PLUGIN_LOCATION', 'mu-plugins', true);
	define ('BAU_PLUGIN_BASE_DIR', WPMU_PLUGIN_DIR, true);
	define ('BAU_PLUGIN_URL', str_replace('http://', BAU_PROTOCOL, WPMU_PLUGIN_URL), true);
	$textdomain_handler = 'load_muplugin_textdomain';
} else if (defined('WP_PLUGIN_URL') && defined('WP_PLUGIN_DIR') && file_exists(WP_PLUGIN_DIR . '/' . BAU_PLUGIN_SELF_DIRNAME . '/' . basename(__FILE__))) {
	define ('BAU_PLUGIN_LOCATION', 'subfolder-plugins', true);
	define ('BAU_PLUGIN_BASE_DIR', WP_PLUGIN_DIR . '/' . BAU_PLUGIN_SELF_DIRNAME, true);
	define ('BAU_PLUGIN_URL', str_replace('http://', BAU_PROTOCOL, WP_PLUGIN_URL) . '/' . BAU_PLUGIN_SELF_DIRNAME, true);
	$textdomain_handler = 'load_plugin_textdomain';
} else if (defined('WP_PLUGIN_URL') && defined('WP_PLUGIN_DIR') && file_exists(WP_PLUGIN_DIR . '/' . basename(__FILE__))) {
	define ('BAU_PLUGIN_LOCATION', 'plugins', true);
	define ('BAU_PLUGIN_BASE_DIR', WP_PLUGIN_DIR, true);
	define ('BAU_PLUGIN_URL', str_replace('http://', BAU_PROTOCOL, WP_PLUGIN_URL), true);
	$textdomain_handler = 'load_plugin_textdomain';
} else {
...
$textdomain_handler('bau', false, BAU_PLUGIN_SELF_DIRNAME . '/languages/');
