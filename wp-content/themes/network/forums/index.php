...
<?php get_header( 'network' ); ?>
	...
	<div id="content">
        ...
        <h2 class="big_title">Forums</h2>
        <div class="caption_inner"><p>Join the conversation. Add your voice and views. Member can join a forum or create one by signing in.</p></div>
