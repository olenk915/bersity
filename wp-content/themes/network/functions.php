...
register_sidebar(
	array(
		'name'          => __( 'Footer Social Media Link', 'network' ),
		'id'            => 'footer-social-media-link',
		'description'   => 'Footer Social Media Link',
		'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4 class="widgettitle">',
        'after_title' => '</h4>'
...
function fb_add_custom_user_profile_fields( $user ) {
    ?>
        ...
        <table class="form-table">
            <tr>
                <th>
                    <label for="address"><?php _e('Youtube Username', 'your_textdomain'); ?>
                </label></th>
                <td>
                    <input type="text" name="yousername" id="yousername" value="<?php echo esc_attr( get_the_author_meta( 'yousername', $user->ID ) ); ?>" class="regular-text" /><br />
                    <span class="description"><?php _e('Please enter your youtube username.', 'your_textdomain'); ?></span>
                </td>
            </tr>
        </table>
    <?php }
    function fb_save_custom_user_profile_fields( $user_id ) {
        ...
        update_usermeta( $user_id, 'yousername', $_POST['yousername'] );
    }
