...
$ft["settings"]["HIDEFILEPATHS"]     = FALSE; // Set to TRUE to pass downloads through .
...
$ft["settings"]["FILEBLACKLIST"]     = "sample2.php filethingie.js ft.css ft_config.php index.php"; // Specific files that will not be shown.
...
/**
 * Check if the a new version of  is available.
 *
