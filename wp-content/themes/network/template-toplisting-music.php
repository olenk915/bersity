<?php
/*
Template Name: Top Listing Music Page
*/
?>
        ...
        <h2 class="big_title"><?php the_title(); ?></h2>
		 	<?php 
					...
					//echo apply_filters('the_content', '[tubepress mode="user" userValue="'.$user_last.'"]');
					    print TubePressPro::getHtmlForShortcode('mode="playlist" playlistValue="PLCQCtoOJpI_Dv_qQQknqkVUFyArB3CwcM" resultsPerPage="21"');
			?>           
          </div> 
         </div>
      <div class="clear"></div>
