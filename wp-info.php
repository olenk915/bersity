<?php
$title = "0.4b14";// Title (may contain HTML tags)
...
$trashcan = "contenttr";            // Trash can (must be located in base directory)
...
$realmname = "WFB";  // Realm name for use with $authmethod = "realm"
...
$unknownuserprofile = "full"; // Profile used for locally unknown users
